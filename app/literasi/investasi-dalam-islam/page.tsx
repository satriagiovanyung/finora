...
import { 
  ...
  ShieldAlert, TrendingUp, ScrollText, HeartHandshake 
} from "lucide-react";
import { motion } from "framer-motion";

export default function InvestasiIslamDashboard() {
  const materiList = [
    { title: "Prinsip Dasar Syariah", desc: "Konsep investasi yang halal dan berkah.", icon: BookOpen, color: "text-emerald-400", href: "/literasi/investasi-dalam-islam/prinsip-dasar" },
    { title: "Riba, Gharar & Maysir", desc: "3 hal utama yang dilarang dalam investasi.", icon: ShieldAlert, color: "text-rose-400", href: "/literasi/investasi-dalam-islam/larangan" },
    { title: "Saham & Reksa Dana Syariah", desc: "Cara memilih aset yang sesuai syariat.", icon: TrendingUp, color: "text-blue-400", href: "/literasi/investasi-dalam-islam/saham-syariah" },
    { title: "Sukuk (Obligasi Syariah)", desc: "Alternatif investasi aman dari negara.", icon: ScrollText, color: "text-purple-400", href: "/literasi/investasi-dalam-islam/sukuk" },
    { title: "Zakat Investasi", desc: "Membersihkan harta dari hasil keuntungan.", icon: HeartHandshake, color: "text-amber-400", href: "/literasi/investasi-dalam-islam/zakat" },
  ];
  ...
  return (
    <main className="min-h-screen bg-[#0A1128] p-4 text-white pb-20 font-sans">
      ...
      <div className="mb-8">
        ...
        >
          <img 
            src="/images/dashboard-islam.jpg" // GANTI DENGAN NAMA FILE GAMBAR ANDA
            alt="Ilustrasi Investasi dalam Islam"
        ...
        >
          <h1 className="mb-2 text-2xl font-bold">Investasi dalam Islam</h1>
          <p className="leading-relaxed text-[#94A3B8] text-sm">
            Pelajari panduan berinvestasi yang tidak hanya berorientasi pada keuntungan, tetapi juga keberkahan sesuai prinsip syariah.
          </p>
        </motion.div>
      </div>
